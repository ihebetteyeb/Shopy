        ...
        <div className="pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6  font-light">
            <div className="col-span-full">
              <label htmlFor="review" className="block text-sm leading-6 text-gray-900">
              Your review *
              </label>
              <div className="mt-2">
                <textarea
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-3">
              <div className="mt-2 flex justify-start">
                ...
                />
                <p className="block text-sm leading-6 text-gray-900"> Save my name, email, and website in this browser for the next time I comment. </p>
            </div>
            </div>
          </div>
