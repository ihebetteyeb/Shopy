    ...
    <div className="md:flex items-start justify-center my-10">
      ...
      <div className="my-1 md:mx-7 ">
        <div className="border-b border-solid border-gray-300">
          <div className="tracking-wide text-2xl font-semibold">organic</div>

          <div className="flex justify-start  pt-3 mt-1 font-medium text-black align-text-bottom">
            <h2 className=" text-xl font-bold pr-2">£35</h2>
            <p className="font-light">+ Free Shipping</p>
          </div>

          <p className="mt-2 font-light">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui
            deleniti, quos recusandae tempore eaque nam neque itaque molestias
            officiis inventore sunt quis expedita quisquam exercitationem
            distinctio quae voluptatibus iste accusantium.
          </p>

          <div className="max-w-md flex justify-start mt-5 lg:flex pb-5 ">
            <input
              type="number"
              className="block border-gray-300 border-[1px] placeholder-gray-400 w-20 p-2 mr-5 text-center "
              placeholder="1"
            />
        ...
        <div className="mt-3 text-sm pb-5">
          <p>
            ...
            <a
              href=""
              className="text-lime-500 hover:text-lime-700 hover:underline pl-2"
            >
              Groceries
            </a>
            <a
